...
function checkLoginName(){
	var strName=document.getElementById("LoginName").value;
	var divName=document.getElementById("z1");
	divName.style.display="inline";
	if(strName==""){
		divName.innerHTML="<font color='red'>请填写用户名</font>";
		return false;
	}
	var reg=/^[\u4E00-\u9FA5]{2,6}$/;
	if(!reg.test(strName)){
...
function checkLoginPass(){
	var strPass=document.getElementById("LoginPass").value;
	var divName=document.getElementById("z2");
	divName.style.display="inline";
	if(strPass==""){
		divName.innerHTML="<font color='red'>请填写密码</font>";
		return false;
	}
	var reg=/^\w{6,16}$/;
	if(!reg.test(strPass)){
...
function checkAlll(){
	...
	if(checkLoginName(LoginName) && checkLoginPass(LoginPass)){
		return true;
	}else{
		alert("验证不通过，请返回重新验证！！");
		return false;
...
<div class="top_hw clearfix">
    <div class="top_h clearfix">
        ...
        <div class="top_hr"><a href="reg.jsp">会员注册</a>  |  <a href="会员登录.html">登录</a>  |  <a href="#">梦想收藏</a>  |  <a href="#">设为首页</a></div>
    </div>
</div>
<div class="head_w">
...
<!-- </div> -->
<div class="b_wrap">
    <div class="current"><span>当前所在地：</span><a href="中国梦想游首页.html">首页</a>  >> <a href="会员登录.html">会员登录</a></div>
    <div class="login_w clearfix">
        <div class="login">
            <div class="login_t">会员登录</div>
            <div class="login_con">
            <form action="" name="" onsubmit="return checkAlll()">
                <table class="login_tab" width="270" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>登录名：</td>
                    <td><input type="text" name="" id="LoginName" value="" placeholder="">
                     <div id="z1" style=" display:none;background-color:#FFF"></div>
                    </td>
                  </tr>
                  <tr>
                    <td>密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
                    <td><input type="text" name="" id="LoginPass" value="" placeholder="">
                     <div id="z2" style=" display:none;background-color:#FFF"></div>
                    </td>
                  </tr>
                  <tr>
                    <td></td>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td>
                        <input type="submit" class="log_b" value="登录" />
                        <a class="back_m" href="#">找回密码</a>
                    </td>
<!--                     <td><a class="log_b" href="会员中心.html" >登 录</a> <a class="back_m" href="#">找回密码</a></td> -->
                  </tr>
                </table>
                </form>
            </div>
            <div class="login_b">
                <p>还不是梦想游会员？  <a class="free_zc" href="#">免费注册</a> </p>
                <p>使用合作网站帐号登录 </p>
